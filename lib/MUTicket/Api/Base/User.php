...
class MUTicket_Api_Base_User extends Zikula_AbstractApi
{
    ...
    public function getlinks()
    {
        ...
        if (in_array('rating', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Rating:', '::', ACCESS_READ)) {
        ...
        if (in_array('supporter', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Supporter:', '::', ACCESS_READ)) {
        ...
        if (in_array('currentState', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':CurrentState:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'currentState')),
                             'text' => $this->__('Current states'),
                             'title' => $this->__('Current state list'));
        }
        if (in_array('label', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Label:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'label')),
                             'text' => $this->__('Labels'),
