...
class MUTicket_Base_UploadHandler
{
    ...
    {
        $this->allowedObjectTypes = array('ticket', 'currentState');
        ...
        $this->allowedFileSizes = array('ticket' => array('images' => 0, 'files' => 0), 'currentState' => array('uploadIcon' => 102400));
    }
