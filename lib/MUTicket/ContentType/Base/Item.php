 ...
 */
class MUTicket_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('MUTicket detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single MUTicket object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('MUTicket', 'external', 'display', $this->getDisplayArguments());
        }
