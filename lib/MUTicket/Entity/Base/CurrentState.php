 ...
 *
 * This is the base entity class for current state entities.
 *
 * @abstract
 */
abstract class MUTicket_Entity_Base_CurrentState extends Zikula_EntityAccess
{
    /**
     * @var string The tablename this object maps to.
     */
    protected $_objectType = 'currentState';
    ...
    /**
     * @var MUTicket_Entity_Validator_CurrentState The validator for this entity.
     */
    ...
    /**
     * Upload icon meta data array.
     *
     * @ORM\Column(type="array")
     * @var array $uploadIconMeta.
     */
    protected $uploadIconMeta = array();
    
    /**
     * @ORM\Column(length=255)
     * @var string $uploadIcon.
     */
    protected $uploadIcon = '';
    
    /**
     * The full path to the upload icon.
     *
     * @var string $uploadIconFullPath.
     */
    protected $uploadIconFullPath = '';
    
    /**
     * Full upload icon path as url.
     *
     * @var string $uploadIconFullPathUrl.
     */
    protected $uploadIconFullPathUrl = '';
     ...
     * Get _validator.
     *
     * @return MUTicket_Entity_Validator_CurrentState
     */
     ...
     * Set _validator.
     *
     * @param MUTicket_Entity_Validator_CurrentState $_validator.
     *
     * @return void
     */
    public function set_validator(MUTicket_Entity_Validator_CurrentState $_validator = null)
    {
    ...
    {
        if ($uploadIcon != $this->uploadIcon) {
            $this->uploadIcon = $uploadIcon;
        }
    }
    
    /**
     * Get upload icon full path.
     *
     * @return string
     */
    public function getUploadIconFullPath()
    {
        return $this->uploadIconFullPath;
    }
    
    /**
     * Set upload icon full path.
     *
     * @param string $uploadIconFullPath.
     *
     * @return void
     */
    public function setUploadIconFullPath($uploadIconFullPath)
    {
        if ($uploadIconFullPath != $this->uploadIconFullPath) {
            $this->uploadIconFullPath = $uploadIconFullPath;
        }
    }
    
    /**
     * Get upload icon full path url.
     *
     * @return string
     */
    public function getUploadIconFullPathUrl()
    {
        return $this->uploadIconFullPathUrl;
    }
    
    /**
     * Set upload icon full path url.
     *
     * @param string $uploadIconFullPathUrl.
     *
     * @return void
     */
    public function setUploadIconFullPathUrl($uploadIconFullPathUrl)
    {
        if ($uploadIconFullPathUrl != $this->uploadIconFullPathUrl) {
            $this->uploadIconFullPathUrl = $uploadIconFullPathUrl;
        }
    }
    
    /**
     * Get upload icon meta.
     *
     * @return array
     */
    public function getUploadIconMeta()
    {
        return $this->uploadIconMeta;
    }
    
    /**
     * Set upload icon meta.
     *
     * @param array $uploadIconMeta.
     *
     * @return void
     */
    public function setUploadIconMeta($uploadIconMeta = Array())
    {
        if ($uploadIconMeta != $this->uploadIconMeta) {
            $this->uploadIconMeta = $uploadIconMeta;
        }
    }
     ...
     *
     * @return MUTicket_Entity_Validator_CurrentState The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new MUTicket_Entity_Validator_CurrentState($this);
    ...
    {
        return 'muticket.ui_hooks.currentstates';
    }
     ...
     *
     * @see MUTicket_Entity_CurrentState::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        if (!empty($this['uploadIcon'])) {
            try {
                $basePath = $controllerHelper->getFileBaseFolder('currentState', 'uploadIcon');
            } catch (Exception $e) {
                return LogUtil::registerError($e->getMessage());
            }
            $fullPath = $basePath .  $this['uploadIcon'];
            $this['uploadIconFullPath'] = $fullPath;
            $this['uploadIconFullPathURL'] = System::getBaseUrl() . $fullPath;
        
            // just some backwards compatibility stuff
            if (!isset($this['uploadIconMeta']) || !is_array($this['uploadIconMeta']) || !count($this['uploadIconMeta'])) {
                // assign new meta data
                $this['uploadIconMeta'] = $uploadManager->readMetaDataForFile($this['uploadIcon'], $fullPath);
            }
        }
     ...
     *
     * @see MUTicket_Entity_CurrentState::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see MUTicket_Entity_CurrentState::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUTicket_Entity_CurrentState::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see MUTicket_Entity_CurrentState::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
    protected function performPostRemoveCallback()
    {
        ...
        foreach ($uploadFields as $uploadField) {
            ...
            $uploadManager->deleteUploadFile('currentState', $this, $uploadField, $objectId);
        }
     ...
     *     - no creation of other entities allowed
     *
     * @see MUTicket_Entity_CurrentState::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see MUTicket_Entity_CurrentState::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUTicket_Entity_CurrentState::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see MUTicket_Entity_CurrentState::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity = new \MUTicket_Entity_CurrentState();
            // unset identifiers
            $entity->setId(null);
            // copy simple fields
            ...
            $entity->setUploadIcon($this->getUploadIcon());
