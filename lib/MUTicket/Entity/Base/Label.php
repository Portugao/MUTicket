 ...
 *
 * This is the base entity class for label entities.
 *
 * @abstract
 */
abstract class MUTicket_Entity_Base_Label extends Zikula_EntityAccess
{
    /**
     * @var string The tablename this object maps to.
     */
    protected $_objectType = 'label';
    ...
    /**
     * @var MUTicket_Entity_Validator_Label The validator for this entity.
     */
     ...
     * Get _validator.
     *
     * @return MUTicket_Entity_Validator_Label
     */
     ...
     * Set _validator.
     *
     * @param MUTicket_Entity_Validator_Label $_validator.
     *
     * @return void
     */
    public function set_validator(MUTicket_Entity_Validator_Label $_validator = null)
    {
     ...
     *
     * @return MUTicket_Entity_Validator_Label The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new MUTicket_Entity_Validator_Label($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'label', 'id' => $this['id'])),
                    'icon' => 'preview',
                    'linkTitle' => __('Open preview page', $dom),
                    'linkText' => __('Preview', $dom)
                );
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'display', 'arguments' => array('ot' => 'label', 'id' => $this['id'])),
                    'icon' => 'display',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'MUTicket:Label:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'label', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'label', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'delete', 'arguments' => array('ot' => 'label', 'id' => $this['id'])),
                        'icon' => 'delete',
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'view', 'arguments' => array('ot' => 'label')),
                    'icon' => 'back',
        ...
        if ($currentType == 'user') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'label', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'label', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                        'linkTitle' => __('Reuse for new item', $dom),
                        'linkText' => __('Reuse', $dom)
                    );
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'delete', 'arguments' => array('ot' => 'label', 'id' => $this['id'])),
                        'icon' => 'delete',
                        'linkTitle' => __('Delete', $dom),
                        'linkText' => __('Delete', $dom)
                    );
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'label')),
                    'icon' => 'back',
                    'linkTitle' => __('Back to overview', $dom),
                    'linkText' => __('Back to overview', $dom)
                );
    ...
    {
        return 'muticket.ui_hooks.labels';
    }
     ...
     *
     * @see MUTicket_Entity_Label::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        if ($currentFunc != 'edit') {
            $this['labelColor'] = ((isset($this['labelColor']) && !empty($this['labelColor'])) ? DataUtil::formatForDisplayHTML($this['labelColor']) : '');
        }
     ...
     *
     * @see MUTicket_Entity_Label::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see MUTicket_Entity_Label::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUTicket_Entity_Label::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see MUTicket_Entity_Label::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see MUTicket_Entity_Label::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see MUTicket_Entity_Label::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUTicket_Entity_Label::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see MUTicket_Entity_Label::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity = new \MUTicket_Entity_Label();
            // unset identifiers
            $entity->setId(null);
            // copy simple fields
            ...
            $entity->setLabelColor($this->getLabelColor());
