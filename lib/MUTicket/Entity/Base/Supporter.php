...
abstract class MUTicket_Entity_Base_Supporter extends Zikula_EntityAccess
{
    ...
    {
        return 'muticket.ui_hooks.supporters';
    }
     ...
     *
     * @see MUTicket_Entity_Supporter::postLoadCallback()
     ...
     *
     * @see MUTicket_Entity_Supporter::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see MUTicket_Entity_Supporter::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUTicket_Entity_Supporter::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see MUTicket_Entity_Supporter::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see MUTicket_Entity_Supporter::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see MUTicket_Entity_Supporter::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUTicket_Entity_Supporter::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see MUTicket_Entity_Supporter::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity = new \MUTicket_Entity_Supporter();
            // unset identifiers
            $entity->setId(null);
            // copy simple fields
            ...
            $entity->setSupportcats($this->getSupportcats());
