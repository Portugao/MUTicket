...
class MUTicket_Entity_Repository_Base_Rating extends EntityRepository
{
    ...
    public function getDescriptionFieldName()
   {
    ...
    public function getAdditionalTemplateParameters($context = '', $args = array())
    {
        ...
        if ($context == 'controllerAction') {
            ...
            if (in_array($args['action'], array('main', 'view'))) {
                ...
                $templateParameters['workflowStateItems'] = $listHelper->getEntries('rating', 'workflowState');
            }
    ...
    protected function getViewQuickNavParameters($context = '', $args = array())
    {
        ...
        $parameters = array();
        $parameters['ticket'] = isset($this->controllerArguments['ticket']) ? $this->controllerArguments['ticket'] : FormUtil::getPassedValue('ticket', 0, 'GET');
    ...
    public function truncateTable()
    {
        ...
        $qb->delete('MUTicket_Entity_Rating', 'tbl');
        $query = $qb->getQuery();
        $query->execute();
    }
    ...
    public function updateCreator($userId, $newUserId)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('MUTicket_Entity_Rating', 'tbl')
    ...
    protected function addCommonViewFilters(QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $categoryFiltersPerRegistry = ModUtil::apiFunc('MUTicket', 'category', 'buildFilterClauses', array('ot' => 'rating', 'catids' => $v));
    ...
    protected function addSearchFilter(QueryBuilder $qb, $fragment = '')
    {
        ...
        $where .= 'tbl.ratingvalue = \'' . $fragment . '\'';
        }
        $where = '(' . $where . ')';
    ...
    {
        $qb->leftJoin('tbl.ticket', 'tblTicket');
