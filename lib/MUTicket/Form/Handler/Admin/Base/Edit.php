 ...
 */
class MUTicket_Form_Handler_Admin_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    protected function writeRelationDataToEntity_rec($entity, $entityData, $plugins)
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof MUTicket_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'assignRelatedItemsToEntity')) {
    ...
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof MUTicket_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'persistRelatedItems')) {
