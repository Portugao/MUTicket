 ...
 * It aims on the current state object type.
 *
 * More documentation is provided in the parent class.
 */
class MUTicket_Form_Handler_Admin_CurrentState_Base_Edit extends MUTicket_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->objectType = 'currentState';
        $this->objectTypeCapital = 'CurrentState';
        $this->objectTypeLower = 'currentstate';

        $this->hasPageLockSupport = true;
        $this->hasCategories = false;
        // array with upload fields and mandatory flags
        $this->uploadFields = array('uploadIcon' => false);
    ...
    {
        // redirect to the list of currentStates
        $viewArgs = array('ot' => $this->objectType);
        $url = ModUtil::url($this->name, 'admin', 'view', $viewArgs);
    
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated currentState
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'currentState', 'id' => $this->idValues['id']));
        }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                        if ($this->mode == 'create') {
                            $message = $this->__('Done! Current state created.');
                        } else {
                            $message = $this->__('Done! Current state updated.');
                        }
                        break;
            case 'delete':
                        $message = $this->__('Done! Current state deleted.');
                        break;
            default:
                        $message = $this->__('Done! Current state updated.');
                        break;
