...
class MUTicket_Form_Handler_Admin_Rating_Base_Edit extends MUTicket_Form_Handler_Admin_Edit
{
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $this->relationPresets['ticket'] = FormUtil::getPassedValue('ticket', '', 'GET');
        if (!empty($this->relationPresets['ticket'])) {
            $relObj = ModUtil::apiFunc($this->name, 'selection', 'getEntity', array('ot' => 'ticket', 'id' => $this->relationPresets['ticket']));
            if ($relObj != null) {
                $relObj->setRating($entity);
            }
        }
