 ...
 */
class MUTicket_Form_Handler_Admin_Supporter_Base_Edit extends MUTicket_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeCapital = 'Supporter';
        $this->objectTypeLower = 'supporter';
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'supporter', 'id' => $this->idValues['id']));
        }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                        if ($this->mode == 'create') {
                            $message = $this->__('Done! Supporter created.');
                        } else {
                            $message = $this->__('Done! Supporter updated.');
                        }
                        break;
            case 'delete':
                        $message = $this->__('Done! Supporter deleted.');
                        break;
            default:
                        $message = $this->__('Done! Supporter updated.');
                        break;
