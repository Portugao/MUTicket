...
class MUTicket_Form_Handler_Admin_Ticket_Base_Edit extends MUTicket_Form_Handler_Admin_Edit
{
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if (!empty($this->relationPresets['parent'])) {
            $relObj = ModUtil::apiFunc($this->name, 'selection', 'getEntity', array('ot' => 'ticket', 'id' => $this->relationPresets['parent']));
            if ($relObj != null) {
        ...
        // editable relation, we store the id and assign it now to show it in UI
        $this->relationPresets['labelticket'] = FormUtil::getPassedValue('labelticket', '', 'GET');
        if (!empty($this->relationPresets['labelticket'])) {
            $relObj = ModUtil::apiFunc($this->name, 'selection', 'getEntity', array('ot' => 'label', 'id' => $this->relationPresets['labelticket']));
            if ($relObj != null) {
                $relObj->addTicketlabel($entity);
            }
        }
