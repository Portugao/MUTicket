 ...
 */
class MUTicket_Form_Handler_User_Label_Base_Edit extends MUTicket_Form_Handler_User_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'user', 'display', array('ot' => 'label', 'id' => $this->idValues['id']));
        }
