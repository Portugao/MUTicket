...
class MUTicket_Form_Handler_User_Rating_Base_Edit extends MUTicket_Form_Handler_User_Edit
{
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'edit') {
            ...
            if ($this->hasTemplateId !== true) {
                $entity['ticket'] = $this->retrieveRelatedObjects('ticket', 'ticket', false);
            }
        }
    ...
    public function fetchInputData(Zikula_Form_View $view, &$args)
    {
        ...
        $entityData['Ticket'] = ((isset($selectedRelations['ticket'])) ? $selectedRelations['ticket'] : $this->retrieveRelatedObjects('ticket', 'muticketTicket_TicketItemList', false, 'POST'));
    ...
    public function reassignRelatedObjects()
    {
        ...
        $selectedRelations['ticket'] = $this->retrieveRelatedObjects('ticket', 'muticketTicket_TicketItemList', false, 'POST');
