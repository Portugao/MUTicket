 ...
 */
abstract class MUTicket_Form_Plugin_Base_AbstractObjectSelector extends Zikula_Form_Plugin_DropdownList
{
    /**
    ...
    public function create(Zikula_Form_View $view, &$params)
    {
        if (!isset($params['objectType']) || empty($params['objectType'])) {
            $view->trigger_error(__f('Error! in %1$s: the %2$s parameter must be specified.', array('muticketRelationSelectorList', 'objectType')));
        }
