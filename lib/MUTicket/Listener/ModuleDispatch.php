 ...
 */
class MUTicket_Listener_ModuleDispatch extends MUTicket_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('MUTicket', 'user', 'main'), 'text' => __('Link Text'));
    }
}
