 ...
 */
class MUTicket_Api_Base_Selection extends Zikula_AbstractApi
{
    /**
    ...
    protected function determineObjectType($args, $methodName = '')
    {
        ...
        if (!in_array($objectType, MUTicket_Util_Controller::getObjectTypes('api', $utilArgs))) {
            $objectType = MUTicket_Util_Controller::getDefaultObjectType('api', $utilArgs);
        }
        return $objectType;
    }
    ...
    protected function getRepository($objectType = '')
    {
        ...
        return $this->entityManager->getRepository('MUTicket_Entity_' . ucfirst($objectType));
    }
