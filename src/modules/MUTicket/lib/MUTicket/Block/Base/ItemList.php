...
class MUTicket_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    ...
    public function info()
    {
        ...
        return array('module'          => 'MUTicket',
            ...
            'text_type_long'  => $this->__('Show a list of MUTicket items based on different criteria.'),
            'allow_multiple'  => true,
            'form_content'    => false,
            'form_refresh'    => false,
            'show_preview'    => true,
    ...
    public function update($blockinfo)
    {
        ...
        if (!in_array($vars['objectType'], MUTicket_Util_Controller::getObjectTypes('block'))) {
            $vars['objectType'] = MUTicket_Util_Controller::getDefaultObjectType('block');
        }
