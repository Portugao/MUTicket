...
class MUTicket_Controller_Base_Admin extends Zikula_AbstractController
{
    ...
    public function view($args)
    {
        ...
        $currentUrlObject = new Zikula_ModUrl('MUTicket', 'admin', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function display($args)
    {
        ...
        $currentUrlObject = new Zikula_ModUrl('MUTicket', 'admin', 'display', ZLanguage::getLanguageCode(), $currentUrlArgs);
