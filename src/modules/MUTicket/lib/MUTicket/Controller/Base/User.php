...
// DEBUG: permission check aspect ends
        ...
        $currentUrlObject = new Zikula_ModUrl('MUTicket', 'user', 'display', ZLanguage::getLanguageCode(), $displayUrlArgs);
...
// DEBUG: permission check aspect ends
    ...
    {
// DEBUG: permission check aspect starts
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('MUTicket::', '::', ACCESS_DELETE));
// DEBUG: permission check aspect ends
        ...
        if ((!is_array($objectData) && !is_object($objectData)) || !isset($objectData[$idFields[0]])) {
            ...
            // fetch and return the appropriate template
            return MUTicket_Util_View::processTemplate($this->view, 'user', $objectType, 'delete', $args);
        }

        // redirect to the list of the current object type
        $this->redirect(ModUtil::url('MUTicket', 'user', 'view',
                                                                                    array('ot' => $objectType)));
