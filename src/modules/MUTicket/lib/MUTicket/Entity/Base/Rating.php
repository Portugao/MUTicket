...
abstract class MUTicket_Entity_Base_Rating extends Zikula_EntityAccess
{
    ...
    /**
     * Adds an instance of MUTicket_Entity_Ticket to the list of ticket.
     *
     * @param MUTicket_Entity_Ticket $ticket.
     *
     * @return void
     */
    public function addTicket(MUTicket_Entity_Ticket $ticket)
    {
        $this->ticket[] = $ticket;
        $nameSingle->setRating($this);
    }

    /**
     * Removes an instance of MUTicket_Entity_Ticket from the list of ticket.
     *
     * @param MUTicket_Entity_Ticket $ticket.
     *
     * @return void
     */
    public function removeTicket(MUTicket_Entity_Ticket $ticket)
    {
        $this->ticket->removeElement($ticket);
        $nameSingle->setRating(null);
    }

    /**
     * Removes an instance of MUTicket_Entity_Ticket from the list of ticket by it's identifier.
     *
