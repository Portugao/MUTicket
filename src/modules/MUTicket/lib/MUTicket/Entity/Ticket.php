...
class MUTicket_Entity_Ticket extends MUTicket_Entity_Base_Ticket
{
    ...
    if ($currentFunc != 'edit') {
        $this['state'] = ((isset($this['state']) && !empty($this['state'])) ? DataUtil::formatForDisplayHTML($this['state']) : '');
    }
        $this['t_rating'] = (int) ((isset($this['t_rating']) && !empty($this['t_rating'])) ? DataUtil::formatForDisplay($this['t_rating']) : 0);
        $this['rated'] = (int) ((isset($this['rated']) && !empty($this['rated'])) ? DataUtil::formatForDisplay($this['rated']) : 0);
