 ...
 */
class MUTicket_Form_Handler_Admin_Base_Config extends Zikula_Form_AbstractHandler
{
	/**
	...
	public function initialize(Zikula_Form_View $view)
	{
		...
		$modVars = ModUtil::getVar('MUTicket');

		$modVars['ratingItems'] = array(
		array('value' => 1, 'text' => __('Yes')),
		array('value' => 0, 'text' => __('No'))
		);
