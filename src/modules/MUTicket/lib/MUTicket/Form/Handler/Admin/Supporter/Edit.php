...

{
    ...
    public function handleCommand(Zikula_Form_View $view, &$args)
    {
       ...
       /* if (isset($supporterData['supportcats']) && is_array($supporterData['supportcats'])) {
        $supporterData['supportcats'] = serialise($supporterData['supportcats']);
		} */
    ...
    //  make dropdownlist for categories
    	...
    	$access = ModUtil::dbInfoLoad('Categories');
    	...
    	$where = "WHERE $categoryregistry_column[modname] = '" . DataUtil::formatForStore('MUTicket') . "' AND $categoryregistry_column[table] = '" . DataUtil::formatForStore('Ticket') . "'";
  	
    	$categorypaths = DBUtil::selectObjectArray('categories_registry', $where);
    	...
    	foreach ($categorypaths as $categorypath) {
    		$where2 = "WHERE $categorycategory_column[parent_id] = '" . DataUtil::formatForStore($categorypath[category_id]) . "'";
    		$categories = DBUtil::selectObjectArray('categories_category',$where2);
