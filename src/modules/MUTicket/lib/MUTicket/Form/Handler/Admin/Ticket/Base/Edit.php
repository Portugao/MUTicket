...
class MUTicket_Form_Handler_Admin_Ticket_Base_Edit extends MUTicket_Form_Handler_Admin_Edit
{
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'edit') {
            ...
            if ($this->hasTemplateId !== true) {
                ...
                $entity['rating'] = $this->retrieveRelatedObjects('rating', 'rating', false);
            }
        }
    ...
    public function reassignRelatedObjects()
    {
        ...
        // reassign the rating eventually chosen by the user
        $selectedRelations['rating'] = $this->retrieveRelatedObjects('rating', 'muticketRating_RatingItemList', false, 'POST');
