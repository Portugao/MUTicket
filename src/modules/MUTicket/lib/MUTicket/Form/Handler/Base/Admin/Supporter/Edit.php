...
class MUTicket_Form_Handler_Base_Admin_Supporter_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if (!is_object($entity) || !isset($entity[$idFields[0]])) {
            ...
            $returnUrl = ModUtil::url('MUTicket', 'admin', 'display', array('ot' => 'supporter', 'id' => $this->idValues['id']));
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete') {
            ...
            $url = ModUtil::url('MUTicket', 'admin', 'display', array('ot' => 'supporter', 'id' => $this->idValues['id']));
        }
        return $url;
    }
