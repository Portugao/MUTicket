 ...
 */
class MUTicket_Form_Handler_Base_User_Rating_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if (!is_object($entity) || !isset($entity[$idFields[0]])) {
            ...
            $returnUrl = ModUtil::url('MUTicket', 'user', 'display', array('ot' => 'rating', 'id' => $this->idValues['id']));
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete') {
            ...
            $url = ModUtil::url('MUTicket', 'user', 'display', array('ot' => 'rating', 'id' => $this->idValues['id']));
        }
        return $url;
    }
