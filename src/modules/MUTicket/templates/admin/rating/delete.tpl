{* purpose of this template: ratings delete confirmation view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    <form class="z-form" action="{modurl modname='MUTicket' type='admin' func='delete' ot='rating' id=$rating.id}" method="post">
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname='MUTicket' type='admin' func='view' ot='rating'}">{icon type='cancel' size='small' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
                </div>
            </fieldset>
