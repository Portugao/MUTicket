...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    {include file='admin/include_categories_edit.tpl' obj=$ticket groupName='ticketObj'}
    {if $mode ne 'create'}
        {include file='admin/include_standardfields_edit.tpl' obj=$ticket}
    {/if}
    {include file='admin/ticket/include_selectOne.tpl' relItem=$ticket aliasName='parent' idPrefix='muticketTicket_Parent'}
