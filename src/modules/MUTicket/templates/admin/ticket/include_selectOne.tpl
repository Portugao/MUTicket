{* purpose of this template: inclusion template for managing related Tickets in admin area *}
<fieldset>
    ...
    <div class="muticketRelationLeftSide">
        {if isset($userSelection.$aliasName) && $userSelection.$aliasName ne ''}
            ...
            {include file='admin/ticket/include_selectItemListOne.tpl' item=$userSelection.$aliasName}
        {elseif $mode ne 'create' || isset($relItem.$aliasName)}
            {include file='admin/ticket/include_selectItemListOne.tpl' item=$relItem.$aliasName}
        {else}
            {include file='admin/ticket/include_selectItemListOne.tpl'}
        {/if}
    </div>
    <br style="clear: both" />
    </div>
