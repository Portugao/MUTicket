...
/**
 * The muticketFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_muticketFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('MUTicket_Form_Plugin_FormFrame', $params, $content);
