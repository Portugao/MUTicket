...
/**
 * The muticketTemplateHeaders plugin performs header() operations
 ...
 */
function smarty_function_muticketTemplateHeaders($params, $view)
{
    if (!isset($params['contentType'])) {
        $render->trigger_error($view->__f('%1$s: missing parameter \'%2$s\'', array('smarty_function_muticketTemplateHeaders', 'contentType')));
    }
