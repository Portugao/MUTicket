...
/**
 * The muticketGetFileSize modifier displays the size of a given file in a readable way.
 *
 ...
 */
function smarty_modifier_muticketGetFileSize($size = 0, $filepath = '', $nodesc = false, $onlydesc = false)
{
    if (!is_numeric($size)) {
        $size = (int)$size;
    }
    ...
    $result = MUTicket_Util_View::getReadableFileSize($size, $nodesc, $onlydesc);
