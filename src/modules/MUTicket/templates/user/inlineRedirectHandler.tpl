...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="{getbaseurl}modules/MUTicket/javascript/MUTicket_editFunctions.js"></script>
    </head>
    <body>
        ...
        /* <![CDATA[ */
            ...
            document.observe('dom:loaded', function() {
                muticketCloseWindowFromInside('{{$idPrefix}}', {{if $commandName eq 'create'}}{{$itemId}}{{else}}0{{/if}});
            });
        /* ]]> */
        </script>
    </body>
