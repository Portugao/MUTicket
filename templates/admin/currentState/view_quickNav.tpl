{* purpose of this template: current states view filter form in admin area *}
{checkpermissionblock component='MUTicket:CurrentState:' instance='::' level='ACCESS_EDIT'}
{assign var='objectType' value='currentState'}
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="muticketCurrentStateQuickNavForm" class="muticketQuickNavForm">
    <fieldset>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        muticketInitQuickNavigation('currentState', 'admin');
