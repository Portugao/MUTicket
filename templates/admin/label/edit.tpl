...
{form cssClass='z-form'}
    ...
    <fieldset>
        ...
        <div class="z-formrow">
            {formlabel for='fontColor' __text='Font color' mandatorysym='1'}
            {muticketColourInput group='label' id='fontColor' mandatory=true __title='Choose the font color of the label' cssClass='required validate-nospace' }
            {muticketValidationError id='fontColor' class='required'}
            {muticketValidationError id='fontColor' class='validate-nospace'}
            {muticketValidationError id='fontColor' class='validate-htmlcolour'}
        </div>
    </fieldset>
    
    {if $mode ne 'create'}
        {include file='admin/include_standardfields_edit.tpl' obj=$label}
    {/if}
