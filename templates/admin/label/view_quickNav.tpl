{* purpose of this template: labels view filter form in admin area *}
{checkpermissionblock component='MUTicket:Label:' instance='::' level='ACCESS_EDIT'}
{assign var='objectType' value='label'}
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="muticketLabelQuickNavForm" class="muticketQuickNavForm">
    <fieldset>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        muticketInitQuickNavigation('label', 'admin');
