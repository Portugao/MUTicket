{* purpose of this template: supporters view filter form in admin area *}
{checkpermissionblock component='MUTicket:Supporter:' instance='::' level='ACCESS_EDIT'}
{assign var='objectType' value='supporter'}
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="muticketSupporterQuickNavForm" class="muticketQuickNavForm">
    <fieldset>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        muticketInitQuickNavigation('supporter', 'admin');
