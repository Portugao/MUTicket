{* purpose of this template: current states display view in user area *}
...
<div class="z-frontendcontainer">
    <h2>{$templateTitle|notifyfilters:'muticket.filter_hooks.currentstates.filter'}{icon id='itemactionstrigger' type='options' size='extrasmall' __alt='Actions' class='z-pointer z-hide'}</h2>
...
{include file='user/include_standardfields_display.tpl' obj=$currentState}
